...
function sunset(){
  let newSunsetColors = sunsetColors
  newSunsetColors[0] = 'blue'
  return newSunsetColors
}
...
function sunrise(){
  let newSunriseColors = sunriseColors.slice()
  newSunriseColors[0] = 'green'
  return newSunriseColors
}
